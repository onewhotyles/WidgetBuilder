...
namespace WidgetBuilder
{
    public partial class PermissionsPage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //Log.Add(LogTypes.Debug, 777, "widget count=>" + user.widgetPermissions.widgets.Count.ToString());
            HtmlGenericControl dataTypeDiv, hTag, configDiv, permissionTable, tr, th, td;

            //Response.Write()
          
                foreach (DataTypeDefinition thisDataType in DataTypeDefinition.GetAll().Where(d => d.DataType != null && d.DataType.Id == propertyEditorGuid))
                {
